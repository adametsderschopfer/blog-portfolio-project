...
(function () {
  ...
  var doAnimationOpen = false;
  window.addEventListener('resize', function () {
    pH = window.innerHeight;
    changeSizeMenu(true);
  });
  var openBtn = document.querySelector('.js-menu-open-button');
  var closeBtn = document.querySelector('.js-menu-close-button');
  var menuPlate = document.querySelector('#menu');
  var menuContent = menuPlate === null || menuPlate === void 0 ? void 0 : menuPlate.querySelector('.js-menu-content');

  function changeSizeMenu(is) {
    menuPlate.style.height = "".concat(is ? pH : 0, "px");
  }

  function toggleMenu() {
    if (doAnimationOpen) return;
    var isActive = !menuPlate.classList.contains('menu__opened');
...
(function () {
  var preSpacedNumber = document.querySelectorAll('.js-space-number');
  if (preSpacedNumber) preSpacedNumber.forEach(function (sN) {});
})();
"use strict";
